            ...
            <Navbar collapseOnSelect expand="lg" bg="" variant="light" fixed='top' className='tw-bg-black/25 tw-backdrop-blur-md py-1'>
                <Container className=''>
                    ...
                    <Navbar.Brand href='/home'>
                        <img src='/logo3.png' className='tw-max-h-12 tw-brightness-200 tw-invert tw-contrast-200' alt="Logo" />
                    </Navbar.Brand>
                                    ...
                                    {userLoggedIn ?
                                        <motion.div>
                                            <Button
                                                ...
                                                className='fw-semibold text-nowrap btn-primary' variant="primary">Log out</Button>
                                        </motion.div>

                                        /* Log in Button*/
                                        : <Button onClick={() => { navigate('/logIn') }}
                                            className='fw-semibold btn-primary' variant="primary">Log in
                                        </Button>}
